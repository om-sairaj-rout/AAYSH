...
const { validateRequiredPhone, validateOptionalPhone } = require("../../utils/phone");
const { resolveInvoiceGeneration } = require("../../utils/invoiceGenerationPolicy");
const {
  parseISODateOnly,
  parseISODateTime,
  ...
  try {
    ...
    for (const [index, row] of rawData.entries()) {
      ...
      const generation = await resolveInvoiceGeneration({
        ...
        generateInvoiceNo: generateUniqueInvoiceNo,
      });
