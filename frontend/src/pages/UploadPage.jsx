import { FileSpreadsheet, CheckCircle, Loader2, AlertCircle, Clock, FileText } from 'lucide-react';
import { useState, useEffect } from 'react';
import { useSelector } from 'react-redux';
import { uploadFile, getUploadHistory } from '../api/uploadAPI';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 font-sans text-slate-700 space-y-8">
      {canWrite ? (
            ...
            <div className="relative group flex-1">
              ...
              <div className={`border-2 border-dashed rounded-xl p-10 flex flex-col items-center justify-center transition-all ${
                file
                  ...
                  : 'border-gray-200 group-hover:border-orange-400 group-hover:bg-orange-50'
              }`}>
        ...
        <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-sm text-slate-500">
          You have view-only access to upload management. Contact your company admin to upload order manifests.
        </div>
      )}
